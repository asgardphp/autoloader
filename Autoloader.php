<?php
namespace Asgard\Autoloader;

class Autoloader {
	protected $search = false;
	protected $nestedNamespace = false;
	...
	public function nestedNamespace($nestedNamespace) {
	...
	public function preloadDir($dir) {
		...
		if($this->cache) {
			$preload = $this->cache->fetch('Asgard\Autoloader\Autoloader\preloadDir\\'.$dir, function() use($file) {
